...
- There are 20 teams that play in a given season. Each data point represents a single team. However, there are 39 total data points. The reason is that at the end of each season, the English Premier League relegates the three teams with the fewest points down to the [2nd tier](https://www.efl.com) for the following season. The three teams from the 2nd tier that earned the most points in the 2nd tier are promoted up to the English Premier League for the following season to replace the three teams that were relegated. Some teams have never been relegated. Other teams have been relegated and promoted multiple times. See [here](https://www.premierleague.com/premier-league-explained) for the official rules.

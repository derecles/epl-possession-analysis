...
In order to view the regression curve generated by R, use [RStudio](https://rstudio.com) to run `generate_visuals.R`

...or open `img/regression_curve_R.png`

In order to view the Google Sheets calculations, open `calculations_GS.xlsx`

In order to view the regression curve generated by Google Sheets, open `img/regression_curve_GS.png`
